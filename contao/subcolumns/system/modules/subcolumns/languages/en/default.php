...
$GLOBALS['TL_LANG']['CTE']['subcolumns'] = array('Column-Set','<img src="system/modules/subcolumns/html/example_de.png" alt="Example for Column-Sets" style="float:right;" />Column-Sets offer the possibility to add a set of columns into your layout. These can even be cascading sets.');
