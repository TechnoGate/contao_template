...
$GLOBALS['TL_LANG']['tl_user']['newsletters'] = array('Listes de diffusion', 'Choisir la/les liste(s) de diffusion que vous souhaitez activer.');
$GLOBALS['TL_LANG']['tl_user']['newsletterp'] = array('Permissions de la liste de diffusion', 'Définir les permissions de la liste de diffusion.');
