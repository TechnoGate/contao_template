...
$GLOBALS['TL_LANG']['MOD']['rss_reader'] = array('Lecteur de flux RSS', 'Importer des flux RSS et les afficher dans le front office.');
$GLOBALS['TL_LANG']['FMD']['rss_reader'] = array('Lecteur de flux RSS', 'Ajoute un flux RSS à la page.');
