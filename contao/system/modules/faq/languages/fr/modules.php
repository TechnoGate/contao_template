...
$GLOBALS['TL_LANG']['MOD']['faq'] = array('FAQ', 'Gérer les questions fréquemment posées.');
$GLOBALS['TL_LANG']['FMD']['faq'] = 'FAQ';
$GLOBALS['TL_LANG']['FMD']['faqlist'] = array('Liste de FAQ', 'Ajoute une liste de questions fréquemment posées.');
$GLOBALS['TL_LANG']['FMD']['faqreader'] = array('Lecteur de FAQ', 'Affiche la réponse à une question fréquemment posée.');
$GLOBALS['TL_LANG']['FMD']['faqpage'] = array('Page de FAQ', 'Afficher la liste de FAQ et le lecteur de FAQ sur la même page.');
