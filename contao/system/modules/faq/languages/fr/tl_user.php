...
$GLOBALS['TL_LANG']['tl_user']['faqs'] = array('Catégories de FAQ autorisées', 'Vous pouvez accorder l\'accès à une ou plusieurs catégories de FAQ.');
$GLOBALS['TL_LANG']['tl_user']['faqp'] = array('Permissions des catégories de FAQ', 'Définir les permissions des catégorie de FAQ.');
