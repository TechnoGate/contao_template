...
$GLOBALS['TL_LANG']['MOD']['registration'] = array('Inscription d\'un utilisateur', 'Permet aux utilisateurs de s\'inscrire sur le site.');
$GLOBALS['TL_LANG']['FMD']['registration'] = array('Formulaire d\'inscription', 'Crée un formulaire d\'inscription.');
$GLOBALS['TL_LANG']['FMD']['lostPassword'] = array('Mot de passe perdu', 'Crée un formulaire de demande de nouveau mot de passe.');
$GLOBALS['TL_LANG']['FMD']['closeAccount'] = array('Fermer le compte', 'Crée un formulaire pour supprimer le compte d\'un membre.');
