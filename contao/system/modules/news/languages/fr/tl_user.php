...
$GLOBALS['TL_LANG']['tl_user']['news'] = array('Archives d\'actualités autorisées', 'Choisir les archives d\'actualités que vous voulez activer pour l\'utilisateur.');
$GLOBALS['TL_LANG']['tl_user']['newp'] = array('Permissions des actualités', 'Définir les permissions des actualités.');
