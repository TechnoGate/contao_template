...
$GLOBALS['TL_LANG']['tl_module']['faq_categories'] = array('Catégories de FAQ', 'Sélectionner une ou plusieurs catégories de FAQ.');
$GLOBALS['TL_LANG']['tl_module']['faq_readerModule'] = array('Module lecteur de FAQ', 'Basculer automatiquement vers le lecteur de FAQ si un élément a été sélectionné.');
