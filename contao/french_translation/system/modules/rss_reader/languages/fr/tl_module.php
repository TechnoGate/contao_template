...
$GLOBALS['TL_LANG']['tl_module']['rss_cache'] = array('Durée du cache', 'Définir la durée pendant laquelle le flux RSS est mis en cache.');
$GLOBALS['TL_LANG']['tl_module']['rss_feed'] = array('URL(s) du (des) flux RSS', 'Saisir l\'URL d\'un ou de plusieurs flux RSS.');
$GLOBALS['TL_LANG']['tl_module']['rss_template'] = array('Modèle de flux RSS', 'Sélectionner un modèle de flux RSS.');
$GLOBALS['TL_LANG']['tl_module']['rss_numberOfItems'] = array('Nombre d\'éléments', 'Limiter le nombre d\'éléments. Saisir 0 pour tout afficher.');
