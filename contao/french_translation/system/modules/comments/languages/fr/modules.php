...
$GLOBALS['TL_LANG']['CTE']['comments'] = array('Commentaires', 'Ajoute à la page un formulaire de saisie de commentaires.');
$GLOBALS['TL_LANG']['FMD']['comments'] = array('Commentaires', 'Gérer les commentaires ou les entrées d\'un livre d\'or.');
$GLOBALS['TL_LANG']['MOD']['comments'] = array('Commentaires', 'Gérer les commentaires ou les entrées d\'un livre d\'or.');
